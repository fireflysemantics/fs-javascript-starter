...
- Release and Changelog Automation with [Release It!][release-it]
- Commit Linting with [commitlint][commitlint]
- [Husky][husky] for triggering commit linting and on commit test automation and linting.
